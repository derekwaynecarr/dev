...
# alias cdo="source /PATH/TO/cdose.sh"
#
# Running `cdose` in a new shell will:
...
source contrib/completions/bash/oadm
...
export OS_ROOT="${GOPATH}/src/github.com/openshift/ose"
